...
import ee.qrent.insurance.api.in.response.InsuranceBalanceTotalResponse;
import ee.qrent.insurance.api.out.InsuranceCaseBalanceLoadPort;
import ee.qrent.insurance.api.out.InsuranceCaseLoadPort;
import ee.qrent.insurance.core.service.InsuranceCaseBalanceCalculator;
...
import ee.qrent.transaction.api.in.response.kind.TransactionKindResponse;
