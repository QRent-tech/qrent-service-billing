...
@AllArgsConstructor
public class RoleAddUpdateDeleteValidator
  ...
  public ViolationsCollector validate(final RoleAddRequest request) {
    ...
    checkUniquenessForAdd(request.getName(), violationsCollector);
  ...
  private void checkUniquenessForAdd(
      final String name, final ViolationsCollector violationCollector) {
