...
@AllArgsConstructor
public class BonusCalculationAddRequestValidator
    implements AddRequestValidator<BonusCalculationAddRequest> {
  ...
  private void checkIfPreviousWeekHasCalculatedObligation(
      final BonusCalculationAddRequest addRequest, final ViolationsCollector violationsCollector) {
    ...
    if (latestCalculatedQWeekId == null) {
      System.out.println(
          "No Bonus Calculation were done yet, current calculation will be the first.");
      return;
    }
