...
class TransactionAddRequestValidatorTest {
  ...
  void init() {
    ...
    instanceUnderTest =
        new TransactionAddRequestValidator(qWeekQuery, transactionLoadPort, balanceLoadPort);
  ...
  public void testAddIfBalanceWasNotCalculated() {
    ...
    request.setTransactionTypeId(3L);
  ...
  public void testAddIfTransactionDateAfterCalculationDate() {
    ...
    final var request = new TransactionAddRequest();
    request.setTransactionTypeId(3L);
    request.setDate(LocalDate.of(2023, Month.JANUARY, 27));
