...
@AllArgsConstructor
public class BalanceCalculationUseCaseService implements BalanceCalculationAddUseCase {
  ...
  private final AddRequestValidator<BalanceCalculationAddRequest> addRequestValidator;
  ...
  @Transactional
  @Override
  public void add(final BalanceCalculationAddRequest request) {
